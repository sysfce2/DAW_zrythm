...
Compilation options: -a data/plugins/zrythm-arch.cpp -lang cpp -fpga-mem-th 4 -ct 1 -cn white_noise -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class white_noise : public dsp {
 ...
 public:
	...
	white_noise(const white_noise&) = default;
	
	virtual ~white_noise() = default;
	
	white_noise& operator=(const white_noise&) = default;
	
	void metadata(Meta* m) { 
		m->declare("author", "Zrythm");
		m->declare("basics.lib/name", "Faust Basic Element Library");
		m->declare("basics.lib/version", "1.22.0");
		m->declare("compile_options", "-a data/plugins/zrythm-arch.cpp -lang cpp -fpga-mem-th 4 -ct 1 -cn white_noise -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
...
namespace zrythm_faust
{
  ...
  std::unique_ptr<zrythm::plugins::faust::dsp> create_white_noise ()
  {
    return std::make_unique<white_noise> ();
  }
   ...
   * compute()).
   */
  void class_init_white_noise (int sample_rate)
  {
    ...
    if (initialized_sample_rate != sample_rate)
      {
        white_noise::classInit (sample_rate);
